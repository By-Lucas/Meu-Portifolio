/*
 * typingEffect()
 * NOME APARECENDO AUTOMATICAMENTE🙃
 */
function typingEffect() {
    const contactTexts = shuffleArray(['Tecnologias e conhecimentos😊', 'Espero que eu atenda os requisítos!😄', 'Fique a vontade, você é bem vindo(a)!🤗']);
